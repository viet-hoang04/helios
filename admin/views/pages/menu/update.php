...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=menu">Danh mục sản phẩm</a></li>
    ...
    <section class="content">
        <form action="index.php?option=menu&act=update" method="post" enctype="multipart/form-data">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title font-weight-bold py-2">Cập nhật menu</h3>
                        <div class="card-tools">
                            <button type="submit" name="UPDATE" class="btn btn-success"><i class="fa fa-save"></i> Lưu[Thêm]</button>
                            <a class="btn btn-secondary" href="index.php?option=menu">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <?php else : ?>
                                    <input type="text" readonly id="name" name="name" value="<?= $row['name'] ?>" class="form-control" required>
                                <?php endif; ?>
                            </div>
                            <div class="form-group">
                                <label for="link">Link</label>
                                <?php if ($row['type'] == 'custom') : ?>
                                    <input id="link" name="link" class="form-control" value="<?= trim($row['link']) ?>">
                                <?php else : ?>
                                    <input id="link" readonly name="link" class="form-control" value="<?= trim($row['link']) ?>">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control custom-select">
                                    <option value="">[--Trạng thái menu--]</option>
